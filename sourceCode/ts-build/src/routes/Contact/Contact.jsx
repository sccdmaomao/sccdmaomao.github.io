...
class Contact extends Component {
    ...
    render() {
        ...
        {socialNetworks.map((contact, index) => (<Card key={`contact-cards-${index}`} interactive 
        ...
        <Card className={styles.showEmail}>
          ...
          <Fade bottom when={this.state.showEmail}>
            <CopyToClipboard text={'sccdmaomao@hotmail.com'} onCopy={this.state.showEmail && this.handleEmailClick}>
